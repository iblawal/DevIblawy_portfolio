...
export default function Home() {
  ...
  const techIcons = [
    ...
    { name: 'Expo SDK', Icon: FaReact, color: '#61DAFB' },
    ...
    { name: "MySQL", Icon: FaNodeJs, color: '#4479A1' },
  ]
    ...
    <>
      ...
      <div className="reveal-right max-w-2xl">
        <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-6">
          I build <strong className="text-primary-600 dark:text-primary-400 font-semibold">mobile and web applications</strong> that solve real-world problems. My focus is split between mobile development and building clean, responsive web solutions — creating high-performance applications that look great and run smoothly.
        </p>

        <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-6">
          Beyond writing code, I work as a <strong className="text-primary-600 dark:text-primary-400 font-semibold">Coding Facilitator and EdTech Consultant</strong> for educational institutions, designing and rolling out digital technology frameworks that prepare the next generation for the tech industry.
        </p>

        <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-8">
          Whether I&apos;m optimizing a mobile UI, building a web platform, or helping a school scale its tech curriculum, my goal is always the same: building digital solutions that make a <strong className="text-primary-600 dark:text-primary-400 font-semibold">tangible impact</strong>.
        </p>
